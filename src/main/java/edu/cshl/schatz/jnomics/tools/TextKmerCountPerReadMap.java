 ...
 * User: james
 */
public class TextKmerCountPerReadMap extends JnomicsMapper<LongWritable, Text, Text, LongWritable>{
    ...
    private HashSet<String> kmerSet = new HashSet<String>();
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        for(int i=0;i<read.length()-ksize+1; ++i){
            ...
            kmerSet.add(kmer.compareTo(kmer_rev) < 0 ? kmer : kmer_rev);
        }
